...
using UnityEditor;
using UnityEngine;
using ICommand = com.ktgame.command_bus.ICommand;
...
namespace com.ktgame.services.command_bus.editor
{
    internal class CommandBusGenerator : AssetPostprocessor
    {
        ...
        [MenuItem("Ktgame/CodeGen/Command Bus Extensions")]
        ...
        private static string GenerateCommandExtensionsContent(out List<string> namespaces)
        {
            ...
            var builder = new StringBuilder();
            builder.Append("\n");
            builder.Append("namespace com.ktgame.services.command_bus").Append("\n");
