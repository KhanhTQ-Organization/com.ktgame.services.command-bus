...
namespace com.ktgame.services.command_bus.editor
{
    public class BuildPreProcessor : IPreprocessBuildWithReport
    {
        public int callbackOrder => 1;

        private const string SettingName = "com.ktgame.services.command_bus";
        private const string PackageName = "com.ktgame.services.command-bus";
